...
import SkillIcons from "../components/icons.tsx";
...
const Skills: React.FC = () => {
  return (
    <section className="section flex-1 flex flex-col p-2 md:p-0 gap-4 items-center justify-center">
      <Typography level="h2">My Skills</Typography>
      <div className="container flex flex-col justify-center items-center md:w-min gap-4">
        <div className="flex flex-col gap-2 border-2 rounded-xl p-4 w-full">
          ...
          <div className="box flex flex-col md:flex-row gap-4">
